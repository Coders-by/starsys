      ...
      choices: [
        {
          ...
          id: "gaze",
          result: "【就是发了个呆】：在无数加班灯光的背景下，你只是默默收拢自己的衣袖。不试图去用算法征服它，也不用理智解剖它，你感到一种超脱的放松。我们终究只是在冷酷的系统间寻找微小生路的凡世旅人。",
          effect: () => { setHumanValue(p => p + 10); }
        },
        {
          label: "专注折叠带有太阳余温的棉质衬衫",
          id: "fold",
          result: "【叠了叠衬衫而已】：一件件抚平褶皱，折叠整齐。粗糙的棉线在手心带来微麻微痒的触感。我们在数字虚无里过得太空，需要洗干净的热水、晒干脆的棉布来抚慰这滚烫温热的实体。",
          effect: () => { setHumanValue(p => p + 15); }
        },
        {
          label: "把头埋进带有淡淡茉莉花香的抱枕里安眠",
          id: "sleep",
          result: "【把头埋进枕头睡一觉】：揉揉酸胀的额头，把脸埋进带有茉莉花余香的暖融靠垫。没有算法，没有关系警报，唯有空气中残留的一丝烤串孜然香气，陪伴你滑入彻底不求解答的睡眠里。",
          effect: () => { setHumanValue(p => p + 10); }
        }
      ]
    }
  ...
  const songList = [
    {
      ...
      title: "《后会无期》",
      era: "高中时代 ㆍ 红星澄澈初识",
      desc: "老式录放机里，一首当年没敢听完的歌。那些因为矜持而未能投递的话，现在补上。",
      lyrics: [
        "当一艘船沉入海底...",
        "当一个人成了谜...",
        "那年高三蝉鸣最响的夏天，她发来QQ：『今晚有流星雨，你快看啊。』",
        "我叉掉了对话框。——不是因为不喜欢你。是因为太喜欢了，喜欢到怕自己配不上。"
      ],
      reflection: "小学那个暑假，她发来流星雨的QQ申请。我其实开心到心脏快炸了，但生怕她看穿我一无所有的贫弱，于是在朋友面前冷傲叉掉对话框，判她下载的魔兽是『联不了机的盗版』。十几年后回头看，我想说的其实很简单：对不起啊，那时候我是个穿补丁校服的小偷，偷了你的勇气却不敢还。"
    },
    {
      id: "qishi",
      title: "《路过人间》",
      era: "青年Gap期 ㆍ 蓝星山海顿悟",
      desc: "在一个人的大平层里冲澡时循环到的歌。热水从头浇到脚，突然想明白了一些事。",
      lyrics: [
        "嗨 意不意外 尘埃落定之后...",
        "路过人间 无非一整面山海，一具温热水滴下冲洗着的凡俗肉身。",
        "在花洒底下站了很久。热气蒙了整面玻璃。我突然发现——我用『凡所有相，皆是虚妄』这句话躲了多少年？它太方便了，方便到只要我看破，就可以不伸手。",
        "【记忆碎片释出】: 真正的解脱不是看破红尘，是明知这具身体会老会死，还是决定热烈地爱恨、痛快地落泪，落落大方地踏入滚烫的烟火里去。"
      ],
      reflection: "在深圳那个大平层的花洒底下站了很久。热水从头浇到脚，我突然在想——我用『凡所有相，皆是虚妄』这句话躲了多少年？它太方便了，方便到只要我看破，我就可以不伸手。可那天《路过人间》响起来的时候我意识到：真正活过的人，不会用看破来当不参与的借口的。"
    },
    {
      id: "sansan",
      title: "《说散就散》",
      era: "关系重叠 ㆍ 金星痛楚共情",
      desc: "有些歌不敢再听第二遍。不是因为不好听，是因为太痛了。",
      lyrics: [
        "抱一抱就当作从没在一起...",
        "因为成长，我们忽而间拆散了对方...",
        "暴雪冬夜，你捧着那杯85°C的茉莉花茶嚎啕大哭。没有优雅降级。没有备用方案。就是痛，就是后悔。",
        "【记忆碎片释出】: 虽然很痛，但我终于踩进了真情那片泥泞里。我爱过了，我痛过了。原来敢痛，比假装不痛要痛快得多。"
      ],
      reflection: "那天在暴雪里捧着热茶嚎啕大哭。没有备用方案，没有优雅降级。就是痛，就是后悔，就是真真切切地觉得自己搞砸了。但哭完之后我发现一件事：原来敢痛，比假装不痛要痛快得多。"
    }
  ];

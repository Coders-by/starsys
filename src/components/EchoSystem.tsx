...
const FRAGMENT_DATABASE: Fragment[] = [
  // 红星 / 情感
  {
    ...
    icon: '🌠',
    name: '流星雨的 QQ 申请',
    subtitle: '2012夏夜，她说"今晚有流星，你当我的哥哥吧"——他装作没看到，叉掉了对话框',
    phrase: '"我假装没看到。"',
    category: '情感线',
    originPlanet: 'red',
    story: '2012的某个夏夜。家里的电脑刚来不久，他在和朋友打《魔兽争霸》。QQ 弹出来一个女孩说『今晚有流星，你当我的哥哥吧』。他在朋友面前装作没看到，叉掉了对话框。',
    details: '不是不喜欢她。是当着哥们面不能承认在乎一个女孩——那会让他在这群男孩里的位置松掉。他也怕靠近她：靠近就得出手，出手就被看穿。叉掉对话框，主动权又回到他手里。这是他自卫的第一块砖。',
  },
  {
    id: 'soul_girl',
    icon: '🌸',
...
const RESONANCE_FORMULAS: Resonance[] = [
  {
    ...
    comment:
      '2012的夏夜，QQ 那头一个女孩说"今晚有流星"——他在朋友面前装作没看到，叉掉了对话框。\n\n2020 年疫情困乡下，soul 上遇到的图书馆员问起未来——他用一星期没上线代替了"我有点想念你"。\n\n大半年简历空白的旷野前——他对自己说"还没准备好"。\n\n三件事的"完美而严苛的理由"，其实都是同一个动作的体面版本。这不是怯懦——是他从小就练熟的"应急策略，立刻逃离"。',
